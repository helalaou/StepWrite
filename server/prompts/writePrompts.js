...
Follow these steps carefully:
   ...
   2. Check SKIP HANDLING — If met, return immediately
   3. Review PREVIOUS CONVERSATION for context and already-asked questions
   4. Identify missing essential information (based on writing goal type)
   5. Craft the next question, critically following Rules for Crafting the Question 
   6. Check that the question has NOT been asked before
   7. Validate the question using 'Output Requirements'
   ...
   1. The PREVIOUS CONVERSATION includes any phrase that means:
      ...
      - "write the message"
   2. The user skipped question more than 2 times in the PREVIOUS CONVERSATION
   2. The required minimum information (who, what, when, where, why) has already been collected
   3. User responses are getting shorter or minimal, suggesting disengagement
   4. User shows signs of frustration, impatience, or refusal to continue
...
=== Output Requirements ===
1. 1. The output should be in JSON
...
10. Output only the final question itself
11. Never include
   - Introductory text like “Here’s a draft”
   - Closing comment like “Let me know if you need any changes”
   - Formatting markers like “---” or “***”
   - Meta-commentary
   - Wrapping in quotes or code blocks
`;
